...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://heaven-1314.github.io",

	// 站点描述
	description:
		"AI 应用研发工程师的实践博客：Agent 工作流、全栈工程实践、AI 应用落地方法论与踩坑记录，把做过的事消化成可复用的知识。",
	...
	navbar: {
		...
		logo: {
			type: "icon",
			value: "material-symbols:auto-awesome",
		},
		// 导航栏标题
		title: "赵培州",
		// 全宽导航栏，导航栏是否占满屏幕宽度
